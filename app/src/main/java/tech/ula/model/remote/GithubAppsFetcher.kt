...
class GithubAppsFetcher(
    ...
    private val baseUrl = "https://raw.githubusercontent.com/Vodkashot28/UserLAnd-next-Assets-Support/$branch/apps"
        ...
        return@withContext try {
            ...
            contents.drop(numLinesToSkip).map { line ->
                ...
                val (
                        ...
                        isPaidApp,
                        version
                ) = line.toLowerCase(Locale.ENGLISH).split(",").map { it.trim() }
                // Construct app
                App(
                        name,
                        category,
