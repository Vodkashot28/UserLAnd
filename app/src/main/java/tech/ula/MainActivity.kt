...
class MainActivity : AppCompatActivity(), SessionListFragment.SessionSelection, BaseFilteredAppsListFragment.AppSelection, FilesystemListFragment.FilesystemListProgress {
    ...
    private val viewModel: MainActivityViewModel by lazy {
        ...
        val assetRepository = AssetRepository(filesDir.path, assetPreferences, githubApiClient, FallbackAssetProvider(this))
    ...
    private fun setNavStartDestination() {
        val onboardingDone = getSharedPreferences("onboarding", Context.MODE_PRIVATE)
    ...
    private fun sendWikiIntent() {
        val intent = Intent("android.intent.action.VIEW", Uri.parse("https://github.com/Vodkashot28/UserLAnd/wiki"))
        startActivity(intent)
    }
